...
\begin{tabular}{|l|l|}
\hline
\textbf{Κινηματική} & \textbf{Έργο \& Ενέργεια} \\ \hline
$u = \frac{dx}{dt}$ & $W = \int \vec{F} \cdot d\vec{r} = \int F dx$ \\
$a = \frac{du}{dt} = \frac{d^2x}{dt^2}$ & $K = \frac{1}{2}m u^2$ \\
$u = u_0 + at$ & $U_{\text{βαρ}} = mgh$ \\
$x = x_0 + u_0 t + \frac{1}{2}at^2$ & $W_{\text{ολ}} = \Delta K$ \\
$u^2 = u_0^2 + 2a\Delta x$ & $E = K + U = \text{σταθ.}$ \\ \hline
\end{tabular}
\end{table}
...
Να θυμάσε πως $\vec{F} = q\vec{E} = m\vec{a}$, που είναι ο δεύτερος νόμος του νεύτωνα. 
Και να συμβουλευτείς του τύπους της μηχανικής και της ελεύθερης βολής για τον υπολογισμό
