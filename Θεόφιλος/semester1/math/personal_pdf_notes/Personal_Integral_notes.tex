...
\hrule
\vspace{0.5em}
\subsubsection*{Τριγωνομετρικές \& Υπερβολικές Ορισμοί}
\[
\begin{array}{rll}
\text{Υπερβ. Ημίτονο:} & \sinh x = \dfrac{e^x - e^{-x}}{2} & : \mathbb{R} \to \mathbb{R} \\[1.5ex]
\text{Υπερβ. Συνημίτονο:} & \cosh x = \dfrac{e^x + e^{-x}}{2} & : \mathbb{R} \to [1, +\infty) \\[1.5ex]
\text{Υπερβ. Εφαπτομένη:} & \tanh x = \dfrac{e^x - e^{-x}}{e^x + e^{-x}} & : \mathbb{R} \to (-1, 1) \\[1.5ex]
\text{Υπερβ. Συνεφαπτομένη:} & \coth x = \dfrac{e^x + e^{-x}}{e^x - e^{-x}} & : \mathbb{R}^* \to (-\infty, -1) \cup (1, +\infty)
\end{array}
\]

\subsubsection*{Τριγωνομετρικές \& Υπερβολικές Αντικαταστάσεις}
\[
\begin{array}{cccc}
\toprule
\text{Ολοκλήρωμα} & \text{Αντικατάσταση} & \text{Ρίζα} & \text{Διαφορικό ($dx$)} \\ 
\midrule
\int f(x, \sqrt{a^2 - x^2})\,dx & x = a \sin u & \sqrt{a^2 - x^2} = a \cos u & dx = a \cos u \, du \\[1.2ex]
\int f(x, \sqrt{a^2 + x^2})\,dx & x = a \sinh u & \sqrt{a^2 + x^2} = a \cosh u & dx = a \cosh u \, du \\[1.2ex]
\int f(x, \sqrt{x^2 - a^2})\,dx & x = a \cosh u & \sqrt{x^2 - a^2} = a \sinh u & dx = a \sinh u \, du \\
\bottomrule
\end{array}
\]
